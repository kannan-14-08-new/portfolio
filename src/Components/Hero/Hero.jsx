  ...
  return (
    ...
    >
      <img
        src={profile_img}
        alt=""
        className="mt-[100px] w-[250px] rounded-full"
      />

      <h1
        className="text-4xl font-bold text-center w-[70%]
       my-name"
      >
        <span
          className="bg-[linear-gradient(270deg,_#DF8908_10%,_#B415FF_100%)]
      ...
      <div
        className="flex items-center gap-[25px] text-[20px] font-bold 
      mb-[50px] hero-buttons"
      >
        <div
          className="bg-[linear-gradient(254deg,_#DF8908_-5.09%,_#B415FF_106.28%)] p-3 rounded-[50px] cursor-pointer
        ...
        <a href={pdf} target="_blank" rel="noopener noreferrer">
          <div
            className="p-3 border-2 cursor-pointer rounded-[50px] font-extralight px-5 hover:border-2 hover:border-[#B415FF]
